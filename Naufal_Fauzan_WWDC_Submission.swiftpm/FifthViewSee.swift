...
struct FifthViewSee: View {
    ...
    @State var userAnswer31 : String = ""
    @State var userAnswer32 : String = ""
    @State var userAnswer33 : String = ""
    ...
    var body: some View {
        ZStack{
            ...
            VStack(alignment: .center){
                Spacer()
                Text("Identify 3 things you can hear👂")
                ...
                Text("Silent... now ask yourself, what can you hear?")
                    ...
                    .padding(.leading, 40)
                    .padding(.bottom, 1)
                Text("For example: rain outside, bird chirping, etc")
                ...
                Group{
                    ...
                    .padding(.bottom, 0)
 //                   Spacer()
                    //                Text("Amazing! Now click the next button to continue!")
                ...
                .multilineTextAlignment(.center)
                Spacer()
                NavigationLink(destination: SixthViewSee(
...
struct FifthSwiftView_Previews: PreviewProvider {
