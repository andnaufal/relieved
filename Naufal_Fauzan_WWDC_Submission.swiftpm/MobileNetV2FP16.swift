...
public class MobileNetV2FP16 {
    ...
    */
    ...
    public class func load(configuration: MLModelConfiguration = MLModelConfiguration(), completionHandler handler: @escaping (Swift.Result<MobileNetV2FP16, Error>) -> Void) {
    ...
    */
    ...
    public class func load(configuration: MLModelConfiguration = MLModelConfiguration()) async throws -> MobileNetV2FP16 {
    ...
    */
    @available(macOS 11.0, iOS 14.0, tvOS 14.0, watchOS 7.0, *)
    public class func load(contentsOf modelURL: URL, configuration: MLModelConfiguration = MLModelConfiguration(), completionHandler handler: @escaping (Swift.Result<MobileNetV2FP16, Error>) -> Void) {
    ...
    */
    @available(macOS 12.0, iOS 15.0, tvOS 15.0, watchOS 8.0, *)
    public class func load(contentsOf modelURL: URL, configuration: MLModelConfiguration = MLModelConfiguration()) async throws -> MobileNetV2FP16 {
